...
//    sealed class Model {
//        // Delegates
//        data class List(val model: com.well.sharedMobile.List.Model) : Model()
//        data class Detail(val model: com.well.sharedMobile.Detail.Model) : Model()
//    }
//
//    sealed class Msg {
//        // Delegates
//        data class List(val msg: com.well.sharedMobile.List.Msg) : Msg()
//        data class Detail(val msg: com.well.sharedMobile.Detail.Msg) : Msg()
//        // Navigation
...
//    sealed class Props {
//        // Delegates
//        data class List(val props: com.well.sharedMobile.List.Props) : Props()
//        data class Detail(val props: com.well.sharedMobile.Detail.Props) : Props()
//    }
//
//    val init1: () -> Pair<Model, Effect<Msg>> = {
//        bimap(List.init1(), Model::List, Msg::List)
//    }
//
