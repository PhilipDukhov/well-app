...
internal class AppleProvider(private val contextHelper: ContextHelper, private val clientId: String, private val redirectUri: String): CredentialProvider(contextHelper.context) {
