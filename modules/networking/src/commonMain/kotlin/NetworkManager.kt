...
class NetworkManager(
    ...
    suspend fun uploadProfilePicture(data: ByteArray): String =
    ...
    suspend fun uploadMessagePicture(data: ByteArray): String =
    ...
    suspend fun sendTechSupportMessage(message: String, path: Path? = null): String =
